...
Data/
├─ YYYY-MM-DD_Data(oliveyoung)_hot.csv
└─ YYYY-MM-DD_Review(oliveyoung)_hot.csv
...
--max-products	최대 상품 수	2
--major-category	대카테고리	"스킨케어"
--middle-category	중카테고리	"에센스/세럼/앰플"
--sorts	정렬 기준	hot, new, hot,new
--reviews-per-product	상품당 리뷰 수	2
