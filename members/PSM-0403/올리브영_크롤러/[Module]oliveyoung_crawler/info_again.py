"""
주성분(main_ingredients)이 없는 상품들을 재크롤링해 주성분을 채웁니다.
...
동작 방식:
  1. TARGET_CSV 에서 main_ingredients가 비어 있는 행을 찾습니다.
...
def find_retry_urls(df: pd.DataFrame) -> list[dict]:
    """
    main_ingredients가 비어 있는 행에서 URL 기준으로 중복 제거한 상품 목록을 반환합니다.
