...
TARGET_CSV = [Path("Data_processed/oliveyoung_신상품순(info)_260503.csv"),
              Path("Data_processed/oliveyoung_신상품순(info)_260504.csv"),
              Path("Data_processed/oliveyoung_신상품순(info)_260505.csv"),
              Path("Data_processed/oliveyoung_신상품순(info)_260506.csv"),
              Path("Data_processed/oliveyoung_신상품순(info)_260507.csv")
]
