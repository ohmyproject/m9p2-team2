...
export async function GET(request: Request) {
  try {
    ...
    const page1Period = (url.searchParams.get("period") || "week") as "week" | "month";
    const { startDate, endDate, comparisonLabel } = getWeeklyRange(page1Period);
...
function getWeeklyRange(period: "week" | "month" = "week") {
  ...
  start.setDate(start.getDate() - (period === "month" ? 59 : 13));
